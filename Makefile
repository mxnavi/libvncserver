...
LOCAL_CFLAGS = -DLIBVNCSERVER_HAVE_ML_EXT -DLIBVNCSERVER_HAVE_LIBJPEG -DLIBVNCSERVER_HAVE_LIBPNG 
LOCAL_CFLAGS += -DLIBVNCSERVER_HAVE_LIBZ -DLIBVNCSERVER_WITH_WEBSOCKETS -Dvncclient_EXPORTS -DLIBVNCSERVER_CONFIG_LIBVA
