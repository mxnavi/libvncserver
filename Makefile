...
LOCAL_CFLAGS += -DLIBVNCSERVER_HAVE_ML_EXT

#LOCAL_CFLAGS += -DLIBVNCSERVER_HAVE_LIBZ -DLIBVNCSERVER_WITH_WEBSOCKETS -Dvncclient_EXPORTS -DLIBVNCSERVER_CONFIG_LIBVA -DLIBVNCSERVER_HAVE_LIBJPEG -DLIBVNCSERVER_HAVE_LIBPNG
